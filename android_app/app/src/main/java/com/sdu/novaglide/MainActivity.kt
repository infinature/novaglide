...
import com.sdu.novaglide.ui.features.newsdetail.NewsDetailScreen
...
fun NovaGlideApp() {
    ...
    NavHost(navController = navController, startDestination = "home") {
        composable("home") {
            HomeScreen(
                ...
                onNavigateToDetail = { newsId -> 
                    // IMPORTANT: URL encode newsId if it can contain special characters
        ...
        composable(
            ...
            // ViewModel will automatically receive newsId via SavedStateHandle
            NewsDetailScreen(
                onNavigateBack = { navController.popBackStack() }
            )
        }
